...
const sourceFiles = [
  ...
  'src/editor/canvas/CanvasAdapter.ts',
  'src/editor/canvas/LegacyCanvasAdapter.ts',
  'src/editor/canvas/KonvaCanvasAdapter.ts',
  'src/editor/persistence/TaskGraphicStateAdapter.ts',
