...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--workspace-id", type=int, default=0, help="Workspace que debe quedar activo tras el login."
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.WARNING("Usa POST /service-login/ con service_token=... o Authorization: Bearer ...")
        )
