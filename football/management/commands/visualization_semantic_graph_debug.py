...
from football.visualization_engine import write_semantic_graph_debug_html


class Command(BaseCommand):
    help = 'Genera un HTML autónomo para inspeccionar el Semantic Graph de una tarea.'
    ...
    def handle(self, *args, **options):
        ...
        out_path = Path(out_raw).expanduser() if out_raw else (Path.home() / 'Downloads' / 'semantic_graph_debug.html')
        written_path = write_semantic_graph_debug_html(task, out_path=out_path)
