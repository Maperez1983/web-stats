...
def _score_candidate(expected: str, candidate: PreferenteCandidate) -> int:
    ...
    expects_youth = any(
        token in expected_lower for token in ("juvenil", "cadete", "infantil", "alevin", "benjamin", "benjam")
    )
...
class Command(BaseCommand):
    help = "Busca en LaPreferente la URL de cada equipo de la liga (grupo) y la guarda en Team.preferente_url."
