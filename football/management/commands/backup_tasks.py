                ...
                payload["sessions"].append(
                    {
                        ...
                        "task_preview_image": (
                            getattr(t.task_preview_image, "name", "") if getattr(t, "task_preview_image", None) else ""
                        ),
                        "updated_at": (
                            timezone.localtime(t.updated_at).isoformat() if getattr(t, "updated_at", None) else None
                        ),
                        "created_at": (
                            timezone.localtime(t.created_at).isoformat() if getattr(t, "created_at", None) else None
                        ),
                    }
                )
                ...
                payload["task_studio"].append(
                    {
                        ...
                        "deleted_at": (
                            timezone.localtime(t.deleted_at).isoformat() if getattr(t, "deleted_at", None) else None
                        ),
                        "tactical_layout": t.tactical_layout,
                        "task_pdf": getattr(t.task_pdf, "name", "") if getattr(t, "task_pdf", None) else "",
                        "task_preview_image": (
