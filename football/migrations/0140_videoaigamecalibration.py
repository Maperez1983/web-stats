        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phase",
                    models.CharField(
                        blank=True, help_text="Parte o tramo: first_half, second_half, custom...", max_length=40
                    ),
                ),
                (
                    "field_points",
                    models.JSONField(
                        blank=True, default=dict, help_text="Puntos normalizados validados por el analista."
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="ai_game_calibrations",
                        to="football.rivalvideo",
                    ),
                ),
            ],
            options={
