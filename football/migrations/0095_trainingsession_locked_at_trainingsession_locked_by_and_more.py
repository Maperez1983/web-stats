            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="football_au_target__1a5485_idx",
                    ),
                    models.Index(fields=["-created_at"], name="football_au_created_eb1e4c_idx"),
                ],
            },
        ),
    ]
