...
from . import video_studio_views
...
urlpatterns = [
    ...
    path('task-studio/task/<int:task_id>/duplicate/', views.task_studio_task_duplicate, name='task-studio-task-duplicate'),
    ...
    path('players/videos/clip/<int:item_id>/', views.player_video_inbox_clip_view_page, name='player-video-inbox-clip-view'),
    path('players/videos/export/<int:item_id>/', views.player_video_inbox_export_view_page, name='player-video-inbox-export-view'),
    path('players/videos/export/<int:item_id>/stream/', views.player_video_inbox_export_stream, name='player-video-inbox-export-stream'),
    path('players/videos/playlist/<int:item_id>/', views.player_video_inbox_playlist_view_page, name='player-video-inbox-playlist-view'),
    path('players/videos/report/<int:item_id>/', views.player_video_inbox_report_view_page, name='player-video-inbox-report'),
    ...
    path('api/match/postmatch/to-blueprints/', views.match_postmatch_pro_to_blueprints_api, name='match-postmatch-pro-to-blueprints-api'),
    ...
    path('share/tactical-playbook/<str:token>/', tactical_views.share_tactical_playbook_clip_page, name='share-tactical-playbook-clip'),
    path('api/share/tactical-playbook/create/', tactical_views.tactical_playbook_clip_share_create, name='share-tactical-playbook-clip-create'),
    ...
    path('api/analysis/rival-report/to-blueprints/', views.analysis_rival_report_to_blueprints_api, name='analysis-rival-report-to-blueprints-api'),
    ...
    path('api/analysis/video-studio/projects/', video_studio_views.analysis_video_studio_projects_api, name='analysis-video-studio-projects-api'),
    path('api/analysis/video-studio/projects/save/', video_studio_views.analysis_video_studio_project_save_api, name='analysis-video-studio-project-save-api'),
    path('api/analysis/video-studio/projects/delete/', video_studio_views.analysis_video_studio_project_delete_api, name='analysis-video-studio-project-delete-api'),
    path('api/analysis/video-studio/clips/', video_studio_views.analysis_video_studio_clips_api, name='analysis-video-studio-clips-api'),
    path('api/analysis/video-studio/clips/save/', video_studio_views.analysis_video_studio_clip_save_api, name='analysis-video-studio-clip-save-api'),
    path('api/analysis/video-studio/clips/delete/', video_studio_views.analysis_video_studio_clip_delete_api, name='analysis-video-studio-clip-delete-api'),
    path('api/analysis/video-studio/voiceovers/', video_studio_views.analysis_video_studio_voiceovers_api, name='analysis-video-studio-voiceovers-api'),
    path('api/analysis/video-studio/voiceovers/upload/', video_studio_views.analysis_video_studio_voiceover_upload_api, name='analysis-video-studio-voiceover-upload-api'),
    path('api/analysis/video-studio/voiceovers/delete/', video_studio_views.analysis_video_studio_voiceover_delete_api, name='analysis-video-studio-voiceover-delete-api'),
    path('api/analysis/video-studio/music/', video_studio_views.analysis_video_studio_music_api, name='analysis-video-studio-music-api'),
    path('api/analysis/video-studio/music/upload/', video_studio_views.analysis_video_studio_music_upload_api, name='analysis-video-studio-music-upload-api'),
    path('api/analysis/video-studio/music/delete/', video_studio_views.analysis_video_studio_music_delete_api, name='analysis-video-studio-music-delete-api'),
    path('api/analysis/video-studio/assign/', video_studio_views.analysis_video_studio_assign_api, name='analysis-video-studio-assign-api'),
    path('api/analysis/video-studio/video/trim/', video_studio_views.analysis_video_studio_video_trim_api, name='analysis-video-studio-video-trim-api'),
    path('api/analysis/video-studio/timeline/', video_studio_views.analysis_video_studio_timeline_api, name='analysis-video-studio-timeline-api'),
    path('api/analysis/video-studio/timeline/save/', video_studio_views.analysis_video_studio_timeline_save_api, name='analysis-video-studio-timeline-save-api'),
    path('api/analysis/video-studio/timeline/delete/', video_studio_views.analysis_video_studio_timeline_delete_api, name='analysis-video-studio-timeline-delete-api'),
    path('api/analysis/video-studio/timeline/export/', video_studio_views.analysis_video_studio_timeline_export_api, name='analysis-video-studio-timeline-export-api'),
    path('api/analysis/video-studio/timeline/import/', video_studio_views.analysis_video_studio_timeline_import_api, name='analysis-video-studio-timeline-import-api'),
    path('api/analysis/video-studio/timeline/clear/', video_studio_views.analysis_video_studio_timeline_clear_api, name='analysis-video-studio-timeline-clear-api'),
    path('api/analysis/video-studio/review/', video_studio_views.analysis_video_studio_review_api, name='analysis-video-studio-review-api'),
    path('api/analysis/video-studio/ocr/dorsal/', video_studio_views.analysis_video_studio_ocr_dorsal_api, name='analysis-video-studio-ocr-dorsal-api'),
    ...
    path('api/analysis/video-studio/export/pdf/', video_studio_views.analysis_video_studio_export_pdf_api, name='analysis-video-studio-export-pdf-api'),
    path('api/analysis/video-studio/export/package/', video_studio_views.analysis_video_studio_export_package_api, name='analysis-video-studio-export-package-api'),
    path('api/analysis/video-studio/export/upload/', video_studio_views.analysis_video_studio_export_upload_api, name='analysis-video-studio-export-upload-api'),
    path('api/analysis/video-studio/export/server/', video_studio_views.analysis_video_studio_export_server_api, name='analysis-video-studio-export-server-api'),
    path('api/analysis/video-studio/export/server-playlist/', video_studio_views.analysis_video_studio_export_server_playlist_api, name='analysis-video-studio-export-server-playlist-api'),
    path('api/analysis/video-studio/export/jobs/create/', video_studio_views.analysis_video_studio_export_job_create_api, name='analysis-video-studio-export-job-create-api'),
    path('api/analysis/video-studio/export/jobs/status/', video_studio_views.analysis_video_studio_export_job_status_api, name='analysis-video-studio-export-job-status-api'),
    path('api/analysis/video-studio/export/jobs/cancel/', video_studio_views.analysis_video_studio_export_job_cancel_api, name='analysis-video-studio-export-job-cancel-api'),
    path('api/analysis/video-studio/report/pdf/', video_studio_views.analysis_video_studio_report_pdf_api, name='analysis-video-studio-report-pdf-api'),
    path('api/analysis/video-studio/ai/', video_studio_views.analysis_video_studio_ai_api, name='analysis-video-studio-ai-api'),
    path('api/analysis/video-studio/ai/track/', video_studio_views.analysis_video_studio_ai_track_api, name='analysis-video-studio-ai-track-api'),
    path('api/analysis/video-studio/ai/pro/', video_studio_views.analysis_video_studio_ai_pro_api, name='analysis-video-studio-ai-pro-api'),
    path('api/analysis/video-studio/autocut/', video_studio_views.analysis_video_studio_autocut_api, name='analysis-video-studio-autocut-api'),
    path('api/analysis/video-studio/share-links/', video_studio_views.analysis_video_studio_share_links_api, name='analysis-video-studio-share-links-api'),
    path('api/analysis/video-studio/frame-capture/', video_studio_views.analysis_video_studio_frame_capture_api, name='analysis-video-studio-frame-capture-api'),
    path('api/analysis/video-studio/track/players/', video_studio_views.analysis_video_studio_track_players_api, name='analysis-video-studio-track-players-api'),
    ...
    path('api/task-assistant/knowledge/upload/', tactical_views.task_assistant_knowledge_upload_api, name='task-assistant-knowledge-upload-api'),
    path('api/tactical-playbook/clips/', tactical_views.tactical_playbook_clips_api, name='tactical-playbook-clips-api'),
    path('api/tactical-playbook/clips/save/', tactical_views.tactical_playbook_clip_save_api, name='tactical-playbook-clip-save-api'),
    path('api/tactical-playbook/tasks/save/', tactical_views.tactical_playbook_task_save_api, name='tactical-playbook-task-save-api'),
    path('api/tactical-playbook/clips/delete/', tactical_views.tactical_playbook_clip_delete_api, name='tactical-playbook-clip-delete-api'),
    path('api/tactical-playbook/clips/favorite/', tactical_views.tactical_playbook_clip_favorite_api, name='tactical-playbook-clip-favorite-api'),
    path('api/tactical-playbook/clips/clone/', tactical_views.tactical_playbook_clip_clone_api, name='tactical-playbook-clip-clone-api'),
    path('api/tactical-playbook/teams/', tactical_views.tactical_playbook_teams_api, name='tactical-playbook-teams-api'),
    path('api/tactical-playbook/versions/', tactical_views.tactical_playbook_versions_api, name='tactical-playbook-versions-api'),
    ...
    path('player/<int:player_id>/portal/', views.player_portal_page, name='player-portal'),
    path('player/me/', views.player_self_portal_page, name='player-self-portal'),
    ...
    path('player/<int:player_id>/informe/editar/', views.player_season_report_edit_page, name='player-season-report-edit'),
    path('player/<int:player_id>/evaluacion/<int:evaluation_id>/informe/', views.player_evaluation_report_page, name='player-evaluation-report'),
    ...
    path('coach/direccion-deportiva/', views.scouting_board_page, name='scouting-board'),
    path('coach/direccion-deportiva/<int:target_id>/', views.scouting_target_detail_page, name='scouting-target-detail'),
    ...
    path('coach/sesiones/porteros/tareas/recursos/', views.sessions_goalkeeper_task_library_page, name='sessions-goalkeeper-task-library'),
    ...
    path('coach/sesiones/preparacion-fisica/tareas/recursos/', views.sessions_fitness_task_library_page, name='sessions-fitness-task-library'),
