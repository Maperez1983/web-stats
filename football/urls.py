...
urlpatterns = [
    ...
    path("coach/seguimiento/<int:watch_id>/nota/", views.season_watch_note, name="season-watch-note"),
    ...
    path("registro-acciones/captura/", views.match_action_capture_page, name="match-action-capture"),
    path("registro-acciones/rival/", views.register_rival_match_action, name="match-action-rival"),
    ...
    # Lo que el asistente no ha sabido hacer: el plan de trabajo, escrito por el uso.
    path("api/system/asistente-pendientes/", views.asistente_pendientes_api, name="asistente-pendientes-api"),
    ...
    path("coach/sesiones/tareas/importar-libro/", views.coach_tasks_import_book, name="coach-tasks-import-book"),
    ...
    path("coach/tactica/planteamiento/<int:plan_id>/rival/", tactical_plan_views.tactical_plan_rival_report, name="tactics-plan-rival-report"),
    # Táctica · Jugadas: el dibujo libre (pases, desmarques, zonas) por pasos, sobre el mismo campo.
    path("coach/tactica/jugadas/", tactical_play_views.tactical_play_page, name="tactics-plays"),
    path("coach/tactica/jugadas/guardar/", tactical_play_views.tactical_play_save, name="tactics-play-save"),
    ...
    path("coach/tactica/jugadas/<int:play_id>/animada.gif", tactical_play_views.tactical_play_gif, name="tactics-play-gif"),
