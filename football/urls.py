...
urlpatterns = [
    ...
    path('api/analysis/video-studio/voiceovers/', views.analysis_video_studio_voiceovers_api, name='analysis-video-studio-voiceovers-api'),
    path('api/analysis/video-studio/voiceovers/upload/', views.analysis_video_studio_voiceover_upload_api, name='analysis-video-studio-voiceover-upload-api'),
    path('api/analysis/video-studio/voiceovers/delete/', views.analysis_video_studio_voiceover_delete_api, name='analysis-video-studio-voiceover-delete-api'),
    path('api/analysis/video-studio/music/', views.analysis_video_studio_music_api, name='analysis-video-studio-music-api'),
    ...
    path('api/analysis/video-studio/export/server-playlist/', views.analysis_video_studio_export_server_playlist_api, name='analysis-video-studio-export-server-playlist-api'),
    path('api/analysis/video-studio/export/jobs/create/', views.analysis_video_studio_export_job_create_api, name='analysis-video-studio-export-job-create-api'),
    path('api/analysis/video-studio/export/jobs/status/', views.analysis_video_studio_export_job_status_api, name='analysis-video-studio-export-job-status-api'),
    path('api/analysis/video-studio/export/jobs/cancel/', views.analysis_video_studio_export_job_cancel_api, name='analysis-video-studio-export-job-cancel-api'),
    ...
    path('api/analysis/video-studio/autocut/', views.analysis_video_studio_autocut_api, name='analysis-video-studio-autocut-api'),
    ...
    path('api/analysis/video-studio/frame-capture/', views.analysis_video_studio_frame_capture_api, name='analysis-video-studio-frame-capture-api'),
    path('api/analysis/video-studio/track/players/', views.analysis_video_studio_track_players_api, name='analysis-video-studio-track-players-api'),
