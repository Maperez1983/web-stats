...
class Group(models.Model):
    ...
    external_id = models.CharField(
        max_length=80, blank=True, help_text="ID externo del grupo (Universo RFAF / LaPreferente)"
    )
...
def _infer_workspace_season_for_team_date(team_id, value):
    ...
    try:
        links = (
            WorkspaceTeam.objects.filter(team_id=int(team_id), workspace__kind=Workspace.KIND_CLUB)
    ...
    if not workspace_ids:
        return None
    return (
        WorkspaceSeason.objects.filter(workspace_id__in=workspace_ids, start_date__lte=value)
...
class StripeEventLog(models.Model):
    ...
    workspace = models.ForeignKey(
        Workspace, null=True, blank=True, on_delete=models.SET_NULL, related_name="stripe_events"
    )
...
class WorkspaceCompetitionContext(models.Model):
    ...
    team = models.ForeignKey(
        Team, on_delete=models.SET_NULL, null=True, blank=True, related_name="competition_contexts"
    )
    group = models.ForeignKey(
        Group, on_delete=models.SET_NULL, null=True, blank=True, related_name="competition_contexts"
    )
    season = models.ForeignKey(
        Season, on_delete=models.SET_NULL, null=True, blank=True, related_name="competition_contexts"
    )
    ...
    external_source_url = models.URLField(
        blank=True, help_text="URL pública (Universo/Preferente/etc.) para revalidar el contexto."
    )
...
class StaffMember(models.Model):
    ...
    federation_license_number = models.CharField(
        max_length=80, blank=True, help_text="Nº licencia federativa (opcional)."
    )
    federation_license_expires_at = models.DateField(
        null=True, blank=True, help_text="Caducidad licencia federativa (opcional)."
    )
    license_updated_at = models.DateTimeField(null=True, blank=True)
    certification_document = models.FileField(
        upload_to="staff/certifications/", null=True, blank=True, help_text="PDF/JPG/PNG de titulación (opcional)."
    )
...
class PlayerCommunication(models.Model):
    ...
    match = models.ForeignKey(
        "Match", on_delete=models.SET_NULL, null=True, blank=True, related_name="player_communications"
    )
...
class Match(models.Model):
    ...
    tournament_name = models.CharField(
        max_length=120, blank=True, help_text="Nombre del torneo (solo si context=Torneo)."
    )
...
class MatchEvent(models.Model):
    ...
    period = models.PositiveSmallIntegerField(
        null=True, blank=True, help_text="Parte del partido o periodo (1, 2, etc.)"
    )
...
class SessionTask(models.Model):
    ...
    deleted_by = models.ForeignKey(
        User, null=True, blank=True, on_delete=models.SET_NULL, related_name="deleted_session_tasks"
    )
...
class AiTrainerEvent(models.Model):
    ...
    workspace = models.ForeignKey(
        Workspace, null=True, blank=True, on_delete=models.SET_NULL, related_name="ai_trainer_events"
    )
...
class AiTrainerTokenWeight(models.Model):
    ...
    workspace = models.ForeignKey(
        Workspace, null=True, blank=True, on_delete=models.SET_NULL, related_name="ai_trainer_token_weights"
    )
...
class AiTrainerDictionaryEntry(models.Model):
    ...
    workspace = models.ForeignKey(
        Workspace, null=True, blank=True, on_delete=models.SET_NULL, related_name="ai_trainer_dictionary_entries"
    )
    ...
    created_by = models.ForeignKey(
        User, null=True, blank=True, on_delete=models.SET_NULL, related_name="ai_trainer_dictionary_entries"
    )
    updated_at = models.DateTimeField(auto_now=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class SessionTaskCollection(models.Model):
    ...
    created_by_user = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="task_collections"
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class ImportedSessionDocument(models.Model):
    ...
    created_by = models.ForeignKey(
        User, null=True, blank=True, on_delete=models.SET_NULL, related_name="imported_session_documents"
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class VideoTelestrationProject(models.Model):
    ...
    team = models.ForeignKey(
        Team, on_delete=models.CASCADE, null=True, blank=True, related_name="video_telestration_projects"
    )
    owner_user = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
...
class VideoTimelineEvent(models.Model):
    ...
    team = models.ForeignKey(
        Team, on_delete=models.CASCADE, null=True, blank=True, related_name="video_timeline_events"
    )
    owner_user = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
...
class VideoClip(models.Model):
    ...
    tags = models.JSONField(default=list, blank=True)
    notes = models.TextField(blank=True)
    overlay = models.JSONField(
        default=dict, blank=True, help_text="Estado de la pizarra (fabric/canvas) para este clip."
    )
...
class VideoAiCorrectionExample(models.Model):
    ...
    clip = models.ForeignKey(
        VideoClip, on_delete=models.SET_NULL, null=True, blank=True, related_name="ai_correction_examples"
    )
...
class VideoAiActionExample(models.Model):
    ...
    clip = models.ForeignKey(
        VideoClip, on_delete=models.SET_NULL, null=True, blank=True, related_name="ai_action_examples"
    )
...
class VideoAiKnowledgeEntry(models.Model):
    ...
    team = models.ForeignKey(
        Team, on_delete=models.CASCADE, null=True, blank=True, related_name="video_ai_knowledge_entries"
    )
...
class VideoAiGameCalibration(models.Model):
    ...
    field_points = models.JSONField(
        default=dict, blank=True, help_text="Puntos normalizados validados por el analista."
    )
    payload = models.JSONField(default=dict, blank=True)
    confidence = models.FloatField(default=0)
    created_by = models.CharField(max_length=80, blank=True)
...
class VideoExportAsset(models.Model):
    ...
    video = models.ForeignKey(
        RivalVideo, on_delete=models.SET_NULL, null=True, blank=True, related_name="export_assets"
    )
...
class AnalysisVideoReportItem(models.Model):
    ...
    clip = models.ForeignKey(
        VideoClip, on_delete=models.SET_NULL, null=True, blank=True, related_name="analysis_report_items"
    )
...
class VideoInboxItem(models.Model):
    ...
    created_by_user = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="video_inbox_sent"
    )
...
class ChunkedRivalVideoUpload(models.Model):
    ...
    created_by_user = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="chunked_video_uploads"
    )
...
class PlayerSeasonReport(models.Model):
    ...
    overall_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="1-10 (opcional)"
    )
    technical_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="1-10 (opcional)"
    )
    tactical_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="1-10 (opcional)"
    )
    physical_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="1-10 (opcional)"
    )
    mental_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="1-10 (opcional)"
    )
    social_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="1-10 (opcional)"
    )
    leadership_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="1-10 (opcional)"
    )
    game_knowledge_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="1-10 (opcional)"
    )
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="created_player_season_reports"
    )
    updated_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="updated_player_season_reports"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class PlayerEvaluation(models.Model):
    ...
    session_minutes = models.PositiveSmallIntegerField(
        null=True, blank=True, help_text="Duración de sesión/partido en minutos."
    )
    ...
    single_leg_control_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="Control monopodal 1-10."
    )
    objective_performance_rating = models.DecimalField(
        max_digits=3,
        decimal_places=1,
        null=True,
        blank=True,
        help_text="Síntesis objetiva 1-10 basada en KPIs/datos disponibles.",
    )
    availability_rating = models.DecimalField(
        max_digits=3, decimal_places=1, null=True, blank=True, help_text="Disponibilidad/asistencia 1-10."
    )
    maturation_status = models.CharField(max_length=16, choices=MATURATION_CHOICES, blank=True, default="")
    maturity_offset_years = models.DecimalField(
        max_digits=4, decimal_places=2, null=True, blank=True, help_text="Años estimados respecto al PHV."
    )
    growth_velocity_cm_year = models.DecimalField(
        max_digits=5, decimal_places=2, null=True, blank=True, help_text="Velocidad de crecimiento cm/año."
    )
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="created_player_evaluations"
    )
    updated_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="updated_player_evaluations"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class ShareLink(models.Model):
    ...
    created_by = models.CharField(max_length=80, blank=True)
    created_by_user = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="share_links"
    )
    is_active = models.BooleanField(default=True)
...
class SessionTaskExportJob(models.Model):
    """
    Cola persistente de exports del editor táctico.

    Mantiene un único registro de verdad para PDF/preview/animación y evita volver
    a abrir flujos legacy sin trazabilidad.
    """

    KIND_PDF_CLUB = "pdf_club"
    KIND_PDF_UEFA = "pdf_uefa"
    KIND_PREVIEW_PNG = "preview_png"
    KIND_AI_PREVIEW = "ai_preview"
    KIND_SEQUENCE_GIF = "sequence_gif"
    KIND_SEQUENCE_MP4 = "sequence_mp4"
    KIND_BOARD_3D = "board_3d"
    KIND_CANVA = "canva"
    KIND_CHOICES = [
        (KIND_PDF_CLUB, "PDF Club"),
        (KIND_PDF_UEFA, "PDF UEFA"),
        (KIND_PREVIEW_PNG, "Preview PNG"),
        (KIND_AI_PREVIEW, "Imagen IA"),
        (KIND_SEQUENCE_GIF, "Secuencia GIF"),
        (KIND_SEQUENCE_MP4, "Secuencia MP4"),
        (KIND_BOARD_3D, "Pizarra 3D"),
        (KIND_CANVA, "Canva / PPT"),
    ]
    ...
    team = models.ForeignKey(Team, on_delete=models.CASCADE, related_name="session_task_export_jobs")
    task = models.ForeignKey(SessionTask, on_delete=models.CASCADE, related_name="export_jobs")
    kind = models.CharField(max_length=40, choices=KIND_CHOICES, default=KIND_PDF_CLUB)
    payload = models.JSONField(default=dict, blank=True)
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default=STATUS_PENDING, db_index=True)
    progress = models.PositiveIntegerField(default=0)
    message = models.CharField(max_length=220, blank=True)
    ...
    created_by_user = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="session_task_export_jobs",
    )
    created_at = models.DateTimeField(auto_now_add=True)
    started_at = models.DateTimeField(null=True, blank=True)
    finished_at = models.DateTimeField(null=True, blank=True)
    ...
    class Meta:
        ordering = ["-created_at", "-id"]
        indexes = [
            models.Index(fields=["team", "task", "-created_at"]),
            models.Index(fields=["team", "status", "-created_at"]),
            models.Index(fields=["status", "-created_at"]),
        ]

    def __str__(self):
        return f"TaskExportJob {self.id} · task#{self.task_id} · {self.kind} · {self.status}"


class AuditEvent(models.Model):
    workspace = models.ForeignKey(
        Workspace, on_delete=models.SET_NULL, null=True, blank=True, related_name="audit_events"
    )
...
class TaskStudioProfile(models.Model):
    ...
    workspace = models.ForeignKey(
        Workspace, on_delete=models.SET_NULL, null=True, blank=True, related_name="task_studio_profiles"
    )
...
class TaskStudioRosterPlayer(models.Model):
    workspace = models.ForeignKey(
        Workspace, on_delete=models.SET_NULL, null=True, blank=True, related_name="task_studio_roster_players"
    )
...
class TaskStudioTask(models.Model):
    workspace = models.ForeignKey(
        Workspace, on_delete=models.SET_NULL, null=True, blank=True, related_name="task_studio_tasks"
    )
    ...
    deleted_at = models.DateTimeField(null=True, blank=True, db_index=True)
    deleted_by = models.ForeignKey(
        User, null=True, blank=True, on_delete=models.SET_NULL, related_name="deleted_task_studio_tasks"
    )
...
class AcademyLessonStep(models.Model):
    ...
    payload = models.JSONField(
        default=dict, blank=True, help_text="Datos extra (p.ej. JSON replay2d, config 3D, etc.)."
    )
...
class AcademyAssignment(models.Model):
    ...
    is_active = models.BooleanField(default=True, db_index=True)
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, blank=True, related_name="academy_assignments_created"
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class AcademyProgress(models.Model):
    ...
    team = models.ForeignKey(
        Team, on_delete=models.SET_NULL, null=True, blank=True, related_name="academy_progress_rows"
    )
    ...
    assignment = models.ForeignKey(
        AcademyAssignment, on_delete=models.SET_NULL, null=True, blank=True, related_name="progress_rows"
    )
    status = models.CharField(max_length=16, choices=STATUS_CHOICES, default=STATUS_NOT_STARTED, db_index=True)
    answers = models.JSONField(
        default=dict, blank=True, help_text="Registro simple de respuestas: {question_id: option_id}"
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["workspace", "user", "lesson"], name="uniq_academy_progress_workspace_user_lesson"
            ),
        ]
        indexes = [
