...
class ManualMatchFixtureCanonicalizationTests(TestCase):
    """
    Reproduce regresión reportada en producción:
    - Convocatoria/11 inicial puede crear un Match "placeholder" (sin away_team real).
    - Luego se crea/edita otro Match para el mismo fixture (con away_team, marcador, result).
    - Se guardan minutos/goles/asistencias manuales sobre el Match real.
    - El dashboard debe colapsar ambos IDs en un único fixture y conservar el Match real como fuente de metadata
      (resultado/marcador) y de overrides.
    """
    ...
    def test_manual_match_stats_and_result_survive_duplicate_match_ids(self):
        ...
        # No debe quedarse con el placeholder sin away_team.
    ...
    def test_cover_image_is_ignored_in_multi_team_when_missing_updated_at(self):
        ...
        try:
            with override_settings(MEDIA_ROOT=media_root):
                ...
                # cover_updated_at NO se establece a propósito (simula clon/legacy).
