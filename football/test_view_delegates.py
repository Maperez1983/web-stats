...
class ViewDelegateTests(SimpleTestCase):
    ...
    def test_session_pdf_imported_task_detection_keeps_manual_tasks_out(self):
        ...
        imported = SimpleNamespace(
            tactical_layout={"meta": {"source": "manual-studio", "pdf_source_name": "a.pdf"}}, task_pdf=None, notes=""
        )
    ...
    def test_team_media_services_block_universo_external_images_by_default(self):
        self.assertEqual(
            team_media_services.sanitize_universo_external_image("https://www.universorfaf.es/pnfg/pimg/escudo.png"),
            "",
        )
    ...
    def test_session_pdf_uses_extracted_crest_service(self):
        team = SimpleNamespace(
            id=7, crest_image=None, crest_url="", is_primary=False, slug="demo", name="Demo", short_name="DM"
        )
        self.assertEqual(
